...
final class ScheduleWeekVC: CollectionViewController {
	...
	override func initialSetup() {
		...
		let layout = ScheduleWeekLayout(dataSource: self)
...
extension ScheduleWeekVC: UIViewControllerPreviewingDelegate {
...
extension ScheduleWeekVC: AnimatedViewControllerTransitionDataSource {
