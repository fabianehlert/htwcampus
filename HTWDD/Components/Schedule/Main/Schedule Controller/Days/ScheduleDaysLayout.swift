...
protocol ScheduleDaysLayoutDataSource: class {
...
extension ScheduleDaysLayoutDataSource {
...
class ScheduleDaysLayout: UICollectionViewLayout {
	...
	private var heightPerHour: CGFloat {
		guard let dataSource = self.dataSource else {
			fatalError("Please set dataSource property of ScheduleDaysLayout before calling \(#function)!")
		}
